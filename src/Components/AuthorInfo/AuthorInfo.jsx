...
import author_img from "../../core/assets/img/author.jpg";

const AuthorInfo = () => {
  return (
    <div className="author-info">
      <div className="wrapper flex-all--center">
        <div className="col--left">
          <div className="author-img">
            <div className="img-wrapper">
              <img src={author_img} alt="author img" className="pic"/>
            </div>
          </div>
        </div>
        <div className="col--right">
          <div className="author-intro">
            ...
            <ul className="social-account-list d-flex align-center">
              <li className="social-account facebook">
                <a href="#">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <li className="social-account instagram">
                <a href="#">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <li className="social-account twitter">
                <a href="#">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <li className="social-account github">
                <a href="#">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
